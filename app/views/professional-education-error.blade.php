	...
	<div class="container exam"> <!--container-->
		...
		<div class="col-md-8">
			...
			$random = DB::table($name)->where('id', $ids)->first(); 
				...
				if($answer =="A"){echo "<label class='block'><input type='radio' value='A' checked>$opt1</label>";}
				else{echo "<label class='block'><input type='radio' value='A' disabled>$opt1</label>";}
				if($answer =="B"){echo "<label class='block'><input type='radio' value='B' checked>$opt2</label>";}
				else{echo "<label class='block'><input type='radio' value='B' disabled>$opt2</label>";}
				if($answer =="C"){echo "<label class='block'><input type='radio' value='C' checked>$opt3</label>";}
				else{echo "<label class='block'><input type='radio' value='C' disabled>$opt3</label>";}
				if($answer =="D"){echo "<label class='block'><input type='radio' value='D' checked>$opt4</label>";}
				else{echo "<label class='block'><input type='radio' value='D' disabled>$opt4</label>";}
				
			?>				
	
			<div class='row top'>
				<div class='col-md-6'>
				<a class="btn" href="{{ URL::to('professional-education') }}">Next Question</a>
				</div>
			</div>
		...
		<div class="col-md-4">
			...
			<div class="panel panel-primary">
				...
				<form name='opt' action='professional-suggest' role='form' method='post'>														
